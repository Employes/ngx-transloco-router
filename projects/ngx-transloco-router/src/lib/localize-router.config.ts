 ...
 */
export const LOCALIZE_ROUTER_FORROOT_GUARD = new InjectionToken<
 ...
 */
export const CACHE_MECHANISM = new InjectionToken<CacheMechanism>(
  "CACHE_MECHANISM"
);
/**
 * Cache name
 ...
 * Cookie cache format
 */
export const INITIAL_NAVIGATION = new InjectionToken<boolean>(
  "INITIAL_NAVIGATION"
);
/**
 * Cookie cache format
 */
export const SCOPE = new InjectionToken<boolean>("SCOPE");
 ...
 */
export const DEFAULT_LANG_FUNCTION = new InjectionToken<
 ...
 */
export const ALWAYS_SET_PREFIX = new InjectionToken<boolean>(
  "ALWAYS_SET_PREFIX"
);
...
export class LocalizeRouterSettings implements LocalizeRouterConfig {
  ...
  constructor(
    ...
    @Inject(INITIAL_NAVIGATION)
    public initialNavigation: boolean = DEFAULT_INITIAL_NAVIGATION,
